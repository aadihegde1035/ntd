      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-white">
              Northern Trust DataWorks is a leading provider of data management solutions, 
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-white">
                ...
                <span>contact@Northernrust.digital</span>
              </div>
              <div className="flex items-center text-white">
                <Phone className="h-5 w-5 mr-2" />
                <span>+1- 602-468-1650</span>
              </div>
              <div className="flex items-center text-white">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-center text-white">
            © {new Date().getFullYear()} Northern Trust DataWorks. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
